 ...
 * @since 1.0.0
 */
public final class TelegramAdapter implements SecureChannelAdapter {
    private static final String PROTOCOL = "TELEGRAM";
    ...
    public TelegramAdapter(String channelId) {
    ...
    public ChannelTrustLevel getChannelTrustLevel() {
        return ChannelTrustLevel.UNTRUSTED_EXTERNAL;
    }

    @Override
    public void start() throws ChannelConnectionException {
        throw new ChannelConnectionException(
            "TelegramAdapter no implementado. Pendiente para futuras versiones."
        );
    }
    ...
    public SovereignEnvelope<String> normalize(Object rawInput, Map<String, String> metadata) {
        throw new UnsupportedOperationException("TelegramAdapter.normalize() no implementado");
    }

    @Override
    public CompletableFuture<Void> sendDirectResponse(String destinationId, String text) {
        return CompletableFuture.failedFuture(
            new UnsupportedOperationException("TelegramAdapter.sendDirectResponse() no implementado")
        );
    }
    ...
    public CompletableFuture<Void> sendMediaResponse(String destinationId, Path mediaFile, String caption) {
        return CompletableFuture.failedFuture(
            new UnsupportedOperationException("TelegramAdapter.sendMediaResponse() no implementado")
        );
    }
