 ...
 * @version 1.0.0
 */
public class OpenFararoniToolWindowAction extends AnAction {

    public OpenFararoniToolWindowAction() {
        super("Abrir Panel Fararoni", "Abrir el panel lateral de chat de Fararoni", MyIcons.FararoniLogo);
    }
